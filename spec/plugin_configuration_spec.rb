...
RSpec.describe Jekyll::WebAwesome::Plugin do
  describe 'transform configuration' do
    ...
    describe '.transform_pages_enabled?' do
      ...
      context 'when site config has transform_pages set to true' do
        let(:site_config) { { 'webawesome' => { 'transform_pages' => true } } }
    ...
    describe '.transform_documents_enabled?' do
      ...
      context 'when site config has transform_documents set to true' do
        let(:site_config) { { 'webawesome' => { 'transform_documents' => true } } }
